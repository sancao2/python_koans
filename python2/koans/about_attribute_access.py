...
class AboutAttributeAccess(Koan):
    ...
    def test_calling_undefined_functions_normally_results_in_errors(self):
        ...
        #self.assertEqual(AttributeError: 'TypicalObject' object has no attribute 'foobar', typical.foobar)
    ...
    class RecursiveCatcher(object):
        ...
        def __getattribute__(self, attr_name):
            ...
            if stack_depth <= 100:  # to prevent a stack overflow
                ...
                # accessed? stackoverflow
                # stack_depth <= 100, answer = 101;
                # stack_depth <= 10, answer = 11
    ...
    def test_getattribute_is_a_bit_overzealous_sometimes(self):
        ...
        catcher.my_method()
        global stack_depth
        self.assertEqual(101, stack_depth)
    ...
    def test_setattr_intercepts_attribute_assignments(self):
        ...
        fanboy.anotherpie= "strawberry"
        self.assertEqual("strawberry", fanboy.a_anotherpie)
