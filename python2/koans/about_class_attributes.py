...
class AboutClassAttributes(Koan):
    ...
    def test_objects_have_methods(self):
        fido = self.Dog()
        self.assertEqual(['__class__', '__delattr__', '__dict__', '__doc__', '__format__', '__getattribute__', '__hash__', '__init__', '__module__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__'], dir(fido))

    def test_classes_have_methods(self):
        self.assertEqual(['__class__', '__delattr__', '__dict__', '__doc__', '__format__', '__getattribute__', '__hash__', '__init__', '__module__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__'], dir(self.Dog))
        self.assertEqual(dir(self.Dog()), dir(self.Dog))

    def test_creating_objects_without_defining_a_class(self):
        singularity = object()
        self.assertEqual(['__class__', '__delattr__', '__doc__', '__format__', '__getattribute__', '__hash__', '__init__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__'], dir(singularity))
        import re
        sub_dir = [x for x in dir(self.Dog()) if re.search(x, str(dir(object()))) == None]
        #self.assertMatch("__doc__", str(dir(object())))
        self.assertEqual(['__dict__', '__module__', '__weakref__'], sub_dir)
    ...
    def test_you_can_explicitly_call_class_methods_from_instance_methods(self):
        ...
        self.assertEqual(['__class__', '__delattr__', '__dict__', '__doc__', '__format__', '__getattribute__', '__hash__', '__init__', '__module__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__', 'a_class_method', 'a_static_method'], dir(fido))
        self.assertEqual(['__class__', '__delattr__', '__dict__', '__doc__', '__format__', '__getattribute__', '__hash__', '__init__', '__module__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__', 'a_class_method', 'a_static_method'], dir(self.Dog4))
        self.assertEqual(fido.__class__, self.Dog4)
