...
class AboutNewStyleClasses(Koan):
    ...
    def test_new_style_classes_have_more_attributes(self):
        self.assertEqual(['__doc__', '__module__'], dir(self.OldStyleClass))
        ...
        self.assertEqual(['__class__', '__delattr__', '__dict__', '__doc__', '__format__', '__getattribute__', '__hash__', '__init__', '__module__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__'], dir(self.NewStyleClass))
    ...
    def test_new_style_classes_have_same_class_as_type(self):
        ...
        self.assertEqual(type(new_style.__class__), self.NewStyleClass.__class__)
        self.assertEqual(
            True,
